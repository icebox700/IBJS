...
$(document).ready(function() {
    ...
    if (userName) {
        ...
        login_buttons.hide();
        itemCount || $('#minicart .cart-empty p').toggle();
    }
    ...
    // Fixing Essents duumb-ass errors. - replacing the edit button on the
    if (window.location.pathname.indexOf('Shipping.html') > 0) {
        $('input[alt="Update"]').each(function(obj) {
            $(this).attr('src', "https://dl.dropbox.com/s/02rud9z3yizyrm1/SelectShipping%402x.png?dl=0");
        })
    }
